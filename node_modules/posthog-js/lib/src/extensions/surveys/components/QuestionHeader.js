...
function Cancel(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("button", { className: "form-cancel", onClick: onClick, disabled: isPreviewMode, "aria-label": "Close survey", type: "button", children: (0, jsx_runtime_1.jsx)("span", { style: { color: 'black' }, children: icons_1.cancelSVG }) }));
}
